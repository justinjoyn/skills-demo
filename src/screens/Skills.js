...
class Skills extends Component {
    ...
    renderAddModal() {
        ...
        return (
            <Modal
                ...
                />
                <StarRatings
                    rating={parseFloat(skillRating ? skillRating : 0)}
                    starRatedColor="#000"
                    starEmptyColor="#ccc"
                    starHoverColor="#222"
                    numberOfStars={5}
                ...
                <div key={skill.id}>
                    <div key={skill.id} className="SkillRow">
                        ...
                        <StarRatings
                            ...
                            rating={parseFloat(skill.rating ? skill.rating : 0)}
                            starRatedColor="#000"
                            starEmptyColor="#ccc"
                            numberOfStars={5}
                            name="rating"
    ...
    renderSubSKills(skills) {
        ...
        skills.map(skill => {
            renderedSkills = renderedSkills.concat(
                <div key={skill.id} className="SubSkillChip">
                    <span className="SubSkillName">{skill.name}</span>
                    <span className="SubSkillRating">
                        {parseFloat(skill.rating ? skill.rating : 0)}
                    </span>
                </div>
            );
            return null;
